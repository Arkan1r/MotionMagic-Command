...
void DriveTrain::MotionMagicDrive() {
	double targetPos = 1 * 4096 * 10.0;

  // mFrontLeftController.Set(ControlMode::MotionMagic, targetPos);
  // mRearLeftController.Set(ControlMode::MotionMagic, targetPos);
  mFrontRightController.Set(ControlMode::MotionMagic, targetPos);
  // mRearRightController.Set(ControlMode::MotionMagic, targetPos);
